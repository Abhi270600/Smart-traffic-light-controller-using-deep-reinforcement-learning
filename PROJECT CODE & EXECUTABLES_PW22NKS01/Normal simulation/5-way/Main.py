...
PHASE_EW_YELLOW = 5
PHASE_EW1_GREEN = 6  # action 2 code 10
PHASE_EW1_YELLOW = 7
PHASE_EW2_GREEN = 8 # action 2 code 10
PHASE_EW2_YELLOW = 9
...
class Simulation:
    ...
    def _collect_waiting_times(self):
        incoming_roads = ["A2TL", "B2TL", "C2TL", "D2TL", "E2TL"]
    ...
    def _set_green_phase(self, action_number):
        if action_number == 0:
            ...
            traci.trafficlight.setPhase("TL", PHASE_EW1_GREEN)
        else:
            traci.trafficlight.setPhase("TL", PHASE_EW2_GREEN)
    ...
    def _get_queue_length(self):
        ...
        halt_E1 = traci.edge.getLastStepHaltingNumber("D2TL")
        halt_E2 = traci.edge.getLastStepHaltingNumber("E2TL")
        queue_length = halt_N + halt_S + halt_E + halt_E1 + halt_E2
        return queue_length
